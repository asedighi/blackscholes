...
public class BrownianMotionTests {
	...
	public static void main(String[] args)
	{
		...
		final RandomVariable brownianMotionRealization	= new RandomVariableFromDoubleArray(3.0);
		RandomVariable sumOfSquaredIncrements 		= new RandomVariableFromDoubleArray(3.0);
